...
urlpatterns = [
    ...
    path("user-by-name/<pk>", UserbyName.as_view(), name="users_By_name"),
    path("current-user", CurrentUser.as_view(), name="CurrentUser"),
    path("user-change-password", UserChangePassword.as_view(), name="ChangePassword"),
    path("user-issue", UserIssueBasicDetails.as_view(), name="UserIssueBasicDetails"),
    path("Teamuser-issue/<id>", TeamUserIssueBasicDetails.as_view(), name="TeamUserIssueBasicDetails"),
